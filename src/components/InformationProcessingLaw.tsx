    ...
    <>
      <div className="mt-8 w-full">
        ...
        <p>
          ...
          datos personales, la autorización suministrada en el presente
          formulario faculta a la Dirección Nacional de Derecho de Autor para
          ...
          antes señalado, de forma tal que la finalidad y uso que la Entidad
          llevará a cabo la información suministrada, será netamente
        ...
        <ol>
          ...
          <li>
            Conocer los usos que se han hecho de la información suministrada,
            cuando así lo solicite el titular.
          </li>
          <li>
            Revocar la autorización y/o solicitar la supresión del dato
            suministrado cuando en el tratamiento realizado no se respeten los
            principios, derechos y garantías constitucionales y legales a favor
            del titular.
          </li>
          <li>
        ...
        <p>
          ...
          <a href="mailto:info@derechodeautor.gov.co">
        ...
        <p>
          ...
          requerimiento según lo establecido por la ley.
        </p>
      </div>
    </>
  );
...
export default InformationProcessingLaw;
